...
<ul class="main-container">
    ...
    <li class="right-pane">
	    <div class="STEM_OVERFLOW">
            <?php $pseudo_nav = 1; include_once('Action/Menu/Menu-Teller.php'); ?>
            <div class="page-content">
				<?php				
                    $th = "church name,province,bank,amount paid,description,teller number,date of payment,payment receipt,created by,date,time";
					...
					$td = JSP_TRANS_PREDEF($td,JSP_ENUMS_GENERIC('BANK'),2);
					$td = JSP_TRANS_DENOM($td,3);
					$td = JSP_TRANS_IMG($td,$BASE,7);
					$td = JSP_TRANS_RID($td,JSP_TABLE_ADMIN,'username',8);
					if (_THROW($predef))
					{
						echo _ERROR($err);						
