...
include_once('Action/Server/Server-Fruit.php');
?>
<!DOCTYPE HTML>
<html>
<head>
...
<ul class="main-container">
    ...
    <li class="right-pane">
	    <div class="STEM_OVERFLOW">
            <?php $pseudo_nav = 1; include_once('Action/Menu/Menu-Fruit.php'); ?>
            <div class="page-content">
				<?php
                    $th = "church name,province,month,year,amount (N),created by,date,time";
					...
					$td = JSP_TRANS_PREDEF($td,JSP_ENUMS_DATE('MONTH'),2);
					$td = JSP_TRANS_PREDEF($td,JSP_ENUMS_DATE('YEAR'),3);					
					$td = JSP_TRANS_DENOM($td,4);
