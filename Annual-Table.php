...
include_once('Action/Server/Server-Annual.php');
?>
<!DOCTYPE HTML>
<html>
<head>
...
<ul class="main-container">
    <li class="left-pane JSP_SPRY_DRAWER_TARGET">    
		<?php $pseudo_menu = 5; include_once('Action/Shared/Menu.php');  ?>
    </li>
    
    <li class="right-pane">
	    <div class="STEM_OVERFLOW">
            <?php $pseudo_nav = 1; include_once('Action/Menu/Menu-Annual.php'); ?>
            <div class="page-content">
				<?php			
                    $th = "church name,province,year,amount (N),created by,date,time";
					...
					$td = JSP_TRANS_PREDEF($td,JSP_ENUMS_DATE('YEAR'),2);
